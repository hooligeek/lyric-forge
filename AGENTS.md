...
Canonical rules for any agent working in this repository. The per-platform files carry the same content because most tools inject their instructions directly and do not follow pointers.
